...
export default function Footer() {
  return (
    <footer className="bg-[#060c09] border-t border-gold/12 py-16">
      <div className="container grid gap-12 md:grid-cols-4">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-display font-bold text-primary">GolfGives</span>
          </div>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-secondary hover:border-gold hover:text-gold transition-all"
              aria-label="Twitter"
            >
